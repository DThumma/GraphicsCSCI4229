/*
 *  Deekshitha Thumma 10/8/17
 *  Assignment 5: Lighting
 *
 *  Draw Art Museum columns, a table with a cool base, and a vase of flowers to demonstrate lighting
 *
 *  Key bindings:
 *  l          Toggles lighting
 ...
 *
 *
 * Resources: Used ex13 code as template and used HW4 objects, 
...
int main(int argc,char* argv[])
{
   ...
   glutCreateWindow("Assignment 5: Deekshitha Thumma");
   //  Set callbacks
